...
import TaskPriorities from '../Insight/TaskPriorities'
					...
					<div className='dashboard-container-card mb-2'>
						...
						<div className='dashboard-second-card'>
							...
							<div className='dashboard-radius-icon'>
								<div className="dashboard-second-card-circle">
									<div className="inner-content">
										<HiOutlineAtSymbol size={25} color='#6F47EB' />
									</div>
								</div>
								<div>
									<p className='task-text'>Assigned Task</p>
									<h3>10.2K</h3>
								</div>
							</div>
							<div className='dashboard-radius-icon'>
								<div className="dashboard-second-card-circle">
									<div className="inner-content">
										<HiOutlineRectangleStack size={25} color='#6F47EB' />
									</div>
								</div>
								<div>
									<p className='task-text'>Boards Task</p>
									<h3>450</h3>
								</div>
							</div>
							<div className='dashboard-radius-icon'>
								<div className="dashboard-second-card-circle">
									<div className="inner-content">
										<HiOutlineCalendar size={25} color='#6F47EB' />
									</div>
								</div>
								<div>
									<p className='task-text'>Completed Task</p>
					...
					<div className='dashboard-center-item-container-insight'>
						<div className='dashboard-center-item'>
							<div className='dashboard-first-card2 mb-2'>
								<div>
									<h5 className='dashboard-first-card-h'>Task Priorities</h5>
									<p className='dashboard-first-card-p'>Team task sorted by priority</p>
								</div>
						...
						<div className='dashboard-center-item'>
							<div className='dashboard-first-card2 mb-2'>
								<div>
									<h5 className='dashboard-first-card-h'>Total Tasks done</h5>
					...
					{/* <div className='dashboard-bottom-item-container'>
						<div className='dashboard-first-card2 mb-2'>
							<div>
								...
								<p className='dashboard-first-card-p'>Teams with assigned tasks</p>
							</div>
							<div className='dashboard-first-icon-boards-move'>
								<div className="dashboard-first-icon-boards" onClick={() => setShowTask(true)}>
									<FiPlus size={18} /> <span>Task</span>
								...
								{data?.map((team: any, index: any) => (
									<div key={index} className='my-teams'>
										...
										<div className='my-teams-flex-imageContainer'>
											...
											<div className='mt-2'>
												{team.teamName.length > 10 ? `${team.teamName.slice(0, 10)} Team...` : team.teamName + " Team"}
											</div>
